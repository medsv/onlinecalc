...
pg = st.navigation(
    {       "": [st.Page("pages/Главная.py", default=True)],
            ...
            "Вода/пар": [st.Page("pages/2_Свойства_воды.py"), 
                         ...
                         st.Page("pages/2_Свойства_влажного_пара.py"), 
                         st.Page("pages/2_Параметры_кипящей_воды.py"),
                         st.Page("pages/2_Температура (давление)_насыщенного_пара.py")],
            "Гидравлика": [st.Page("pages/3_Скорость_среды_в_трубе.py"),
                           st.Page("pages/3_Кавитационный_запас.py"),
                           st.Page("pages/3_Пропускная_способность.py"),
                           ]
        }
)
pg.run()
